...
*   **CustomTkinter:** Framework de interface gráfica moderno para Python. Foi escolhido por permitir a criação de componentes nativos estilizados com alta performance e suporte a temas customizados, dando vida ao visual *Dark Mocha*.
